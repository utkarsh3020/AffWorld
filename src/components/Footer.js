            ...
            <div class="footer-content-column">
              <div class="footer-logo">
                <a class="footer-logo-link" href="#">
                  <h1><span>A</span>ff<span>W</span>orld</h1>
                </a>
              </div>
              <div class="footer-menu">
                <p>We are available here 24*7 for you to reach out to us incase you have any queries or any doubts you have regading our services or our website.</p>
              </div>
            </div>
            <div class="footer-content-column">
              <div class="footer-menu">
            ...
            <div class="footer-copyright-wrapper">
              <p class="footer-copyright-text">
                <a class="footer-copyright-link" href="#" target="_self">
                  {" "}
                  © 2021. | The Miracle Solutions. | All rights reserved.{" "}
                </a>
              </p>
            </div>
          </div>
